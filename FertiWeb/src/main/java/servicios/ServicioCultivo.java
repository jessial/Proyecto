...
public class ServicioCultivo {
	...
	@CrossOrigin(origins = "http://localhost:4200")
	@DeleteMapping("borrarCultivo")
	@ResponseBody
	public ResponseEntity<Object> eliminar(@RequestBody CultivoSembrado cultivoSembrado) {
		controladorDatos.eliminarTipoCultivo(cultivoSembrado);
		return new ResponseEntity<>(null, HttpStatus.ACCEPTED);
	}
}
